...
www-data ALL=(ALL) NOPASSWD: /bin/mkdir, /bin/chown, /bin/cp, /bin/ln, /bin/cat, /bin/rm, /usr/bin/git, /usr/sbin/nginx, /usr/bin/systemctl reload nginx, /usr/bin/systemctl restart nginx, /usr/bin/systemctl start cloudflared-tunnel, /usr/bin/systemctl stop cloudflared-tunnel, /usr/bin/systemctl enable cloudflared-tunnel, /usr/bin/systemctl disable cloudflared-tunnel, /usr/bin/systemctl daemon-reload, /usr/bin/mysql
EOF
